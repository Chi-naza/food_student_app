...
import 'package:food_app2/src/features/view/push_notifications.dart';
...
class NotificationController {
  ...
  static Future<void> onActionReceivedImplementationMethod(
      ReceivedAction receivedAction) async {
    MyAppScreen.navigatorKey.currentState?.pushNamedAndRemoveUntil(
        '/notification-page',
        (route) =>
  ...
  static Future<bool> displayNotificationRationale() async {
    ...
    BuildContext context = MyAppScreen.navigatorKey.currentContext!;
    await showDialog(
        context: context,
