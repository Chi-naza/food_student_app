...
class AuthController extends GetxController {
  ...
  Future<void> registerUser(
    ...
    try {
      final credential =
        ...
        email: email,
        password: password, // nanocodes.ng21@gmail.com
      );

      showSnackBar(
        message:
            "Account has been created for ${credential.user!.email}.\nKindly verify your email address in order to login",
        isError: false,
      );
  ...
  Future<void> loginUser(
    ...
    try {
      ...
      final bool isUserVerified = credential.user!.emailVerified;
